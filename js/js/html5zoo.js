    ...
    $.fn.html5zoo = function(G) {
        ...
        J.prototype = {
            ...
            createMarkup: function() {
                this.$wrapper = jQuery("" + "<div class='html5zoo-wrapper-" + this.id + "'>" + "<div class='html5zoo-background-image-" + this.id + "'></div>"  + "<div class='html5zoo-slider-" + this.id + "'>" + "<div class='html5zoo-box-" + this.id + "'>" + "<div class='html5zoo-swipe-box-" + this.id + "'>" + "<div class='html5zoo-space-" + this.id + "'></div>" + "<div class='html5zoo-img-box-" + this.id + "'></div>" + "</div>" + "</div>" + "<div class='html5zoo-text-wrapper-" + this.id + "'></div>" + "<div class='html5zoo-play-" + this.id + "'></div>" + "<div class='html5zoo-video-wrapper-" + this.id + "'></div>" + "<div class='html5zoo-ribbon-" + this.id + "'></div>" + "<div class='html5zoo-arrow-left-" + this.id + "'></div>" + "<div class='html5zoo-arrow-right-" + this.id + "'></div>" + "</div></div>");
